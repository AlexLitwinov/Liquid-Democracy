...
behaviour of the Liquid Democracy system (without experts only lays)
...
![](Simulations_files/figure-gfm/plot-margins-1.png)<!-- --> \## Yes/No
Table
...
| Responsiveness |   T | Direct Yes | Direct No | Liquid Yes | Liquid No | Lost Votes |
|---------------:|----:|-----------:|----------:|-----------:|----------:|-----------:|
|            0.1 |  50 |        122 |       128 |       70.2 |      86.8 |       93.0 |
|            0.5 |  50 |        122 |       128 |       75.4 |      99.2 |       75.4 |
|            1.0 |  50 |        122 |       128 |       87.4 |     113.6 |       49.0 |
|            2.0 |  50 |        122 |       128 |       99.0 |     119.2 |       31.8 |
|            5.0 |  50 |        122 |       128 |      101.2 |     124.2 |       24.6 |
|           10.0 |  50 |        122 |       128 |      103.4 |     124.0 |       22.6 |
|           25.0 |  50 |        122 |       128 |      103.4 |     124.0 |       22.6 |
|            0.1 | 100 |        122 |       128 |       90.2 |      92.8 |       67.0 |
|            0.5 | 100 |        122 |       128 |      101.0 |      89.4 |       59.6 |
|            1.0 | 100 |        122 |       128 |      102.0 |     111.8 |       36.2 |
|            2.0 | 100 |        122 |       128 |      110.6 |     114.2 |       25.2 |
|            5.0 | 100 |        122 |       128 |      117.2 |     119.8 |       13.0 |
|           10.0 | 100 |        122 |       128 |      120.0 |     116.0 |       14.0 |
|           25.0 | 100 |        122 |       128 |      122.0 |     113.0 |       15.0 |
|            0.1 | 200 |        122 |       128 |       60.6 |     123.2 |       66.2 |
|            0.5 | 200 |        122 |       128 |       73.0 |     115.6 |       61.4 |
|            1.0 | 200 |        122 |       128 |       87.4 |     125.8 |       36.8 |
|            2.0 | 200 |        122 |       128 |      103.0 |     123.0 |       24.0 |
|            5.0 | 200 |        122 |       128 |      108.2 |     124.6 |       17.2 |
|           10.0 | 200 |        122 |       128 |      111.8 |     117.8 |       20.4 |
|           25.0 | 200 |        122 |       128 |      110.2 |     120.6 |       19.2 |
|            0.1 | 500 |        122 |       128 |       75.6 |      88.8 |       85.6 |
|            0.5 | 500 |        122 |       128 |       89.6 |      93.0 |       67.4 |
|            1.0 | 500 |        122 |       128 |      107.4 |     104.2 |       38.4 |
|            2.0 | 500 |        122 |       128 |      105.4 |     116.8 |       27.8 |
|            5.0 | 500 |        122 |       128 |      116.8 |     118.0 |       15.2 |
|           10.0 | 500 |        122 |       128 |      120.6 |     113.2 |       16.2 |
|           25.0 | 500 |        122 |       128 |      120.2 |     116.4 |       13.4 |

Yes/No Vote Counts: Direct vs. Liquid Democracy (averaged over rewiring
conditions)
...
```
    ...
    ## # ℹ 130 more rows
    ## # ℹ 17 more variables: max_ideological_drift <dbl>, pct_high_drift <dbl>,
    ...
    ## #   direct_yes <dbl>, direct_no <dbl>, liquid_yes <dbl>, liquid_no <dbl>,
